 ...
 *
 * <p>All addController-Methods are located inside the ControlP5Base class.
 *
...
public class ControlP5 extends ControlP5Base {
  ...
  public static final PFont BitFontStandard56 =
      new BitFont(CP.decodeBase64(BitFont.standard56base64));
  public static final PFont BitFontStandard58 =
      new BitFont(CP.decodeBase64(BitFont.standard58base64));
   ...
   * state. to turn of auto intialization, call setAutoInitialization(false) right after
   ...
   * draw() function ). to turn off the auto drawing of controlP5, use controlP5.setAutoDraw(false).
   * now you can call controlP5.draw() any time whenever controllers should be drawn into the
   * sketch.
   *
   * @param theFlag boolean
   */
   ...
   * name. If not, accessing Controllers by name is not guaranteed. the rule here is last come last
   * serve, existing Controllers with the same name will be overridden.
   *
   * @param theController ControllerInterface
   * @return ControlP5
   */
  public ControlP5 register(
      Object theObject, String theIndex, ControllerInterface<?> theController) {
    String address = "";
  ...
  /**
   * Returns a list of controllers or groups of a particular type. The following example will return
   * a list of registered Bangs only:<br>
   * <code><pre>
   ...
   *
   * <p>TODO Fix this. this only removes the reference to a controller from the controller map but
   ...
   * Other key events are still available like ALT-h to hide and show the controllers To disable all
   * key events, use disableKeys()
   */
  ...
  /**
   * cp5.begin() and cp5.end() are mechanisms to auto-layout controllers, see the ControlP5beginEnd
   * example.
   */
  ...
  public static Object invoke(
      final Object theObject, final String theMember, final Object... theParams) {
  ...
  public static boolean b(Object o, boolean theDefault) {
    return (o instanceof Boolean)
        ? ((Boolean) o).booleanValue()
        : (o instanceof Number) ? ((Number) o).intValue() == 0 ? false : true : theDefault;
  }
  ...
  public static boolean b(String o, boolean theDefault) {
  ...
  public static int i(Object o, int theDefault) {
    return (o instanceof Number)
        ? ((Number) o).intValue()
        : (o instanceof String) ? i(s(o)) : theDefault;
  }

  public static int i(String o) {
    return i(o, Integer.MIN_VALUE);
  }

  public static int i(String o, int theDefault) {
  ...
  public static float f(Object o, float theDefault) {
    return (o instanceof Number)
        ? ((Number) o).floatValue()
        : (o instanceof String) ? f(s(o)) : theDefault;
  }
  ...
  public static float f(String o, float theDefault) {
  ...
  public static double d(Object o, double theDefault) {
    return (o instanceof Number)
        ? ((Number) o).doubleValue()
        : (o instanceof String) ? d(s(o)) : theDefault;
  }

  public static double d(String o) {
    return d(o, Double.MIN_VALUE);
  }

  public static double d(String o, double theDefault) {
  ...
  public static long l(Object o, long theDefault) {
    return (o instanceof Number)
        ? ((Number) o).longValue()
        : (o instanceof String) ? l(s(o)) : theDefault;
  }
  ...
  public static List toList(final Object... args) {
  ...
  public static List toList(Object o) {
    return o != null
        ? (o instanceof List)
            ? (List) o
            : (o instanceof String) ? toList(o.toString()) : Collections.EMPTY_LIST
        : Collections.EMPTY_LIST;
  }

  public static Map toMap(final String s) {
  ...
  public static Map toMap(final Object... args) {
    Map m = new LinkedHashMap();
    if (args.length % 2 == 0) {
  ...
  public static String s(String o) {
    return (o != null) ? o : "";
  }

  static Map<Class<?>, Class<?>> classmap =
