...
public class BitFont extends PFont {
  ...
  public static final String standard58base64 =
  ...
  public static final String standard56base64 =
  ...
  public static final String grixelbase64 =
  ...
  public BitFont(byte[] theBytes) {
    ...
    for (int i = 0; i < 128; i++) {
      ...
      try {
        Constructor<PFont.Glyph>[] constructors =
            (Constructor<PFont.Glyph>[]) PFont.Glyph.class.getDeclaredConstructors();
        Constructor<PFont.Glyph> constructor =
            (Constructor<PFont.Glyph>) PFont.Glyph.class.getDeclaredConstructors()[0];
  ...
  BitFont make() {
    ...
    for (int i = 0; i < characters; i++) {
      ...
      for (int u = 0; u < charWidth[i] * charHeight; u++) {
        chars[i][u] =
            texture.pixels[indent + (u / charWidth[i]) * texture.width + (u % charWidth[i])]
                    == 0xff000000
                ? 1
                : 0;
      }
