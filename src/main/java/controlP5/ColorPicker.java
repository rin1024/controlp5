...
public class ColorPicker extends ControlGroup<ColorPicker> {
  ...
  protected ColorPicker(
    ...
    sliderBlue =
        cp5.addSlider(theName + "-blue", 0, 255, 0, (theHeight + 1) * 2, theWidth, theHeight);
    ...
    sliderAlpha =
        cp5.addSlider(theName + "-alpha", 0, 255, 0, (theHeight + 1) * 3, theWidth, theHeight);
  ...
  public ColorPicker setColorValue(int theColor) {
    setArrayValue(
        new float[] {
          theColor >> 16 & 0xff, theColor >> 8 & 0xff, theColor >> 0 & 0xff, theColor >> 24 & 0xff
        });
    return this;
  }

  public int getColorValue() {
    return 0xffffffff & (int) (_myArrayValue[3]) << 24
        | (int) (_myArrayValue[0]) << 16
        | (int) (_myArrayValue[1]) << 8
