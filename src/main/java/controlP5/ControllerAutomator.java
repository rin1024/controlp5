...
public class ControllerAutomator {
  ...
  static Map<String, Class<? extends ControllerInterface<?>>> types =
      new HashMap<String, Class<? extends ControllerInterface<?>>>();
  ...
  public void addControllersFor(final String theAddressSpace, final Object t) {
    ...
    Map<ControllerInterface, Integer> controllersIndexed =
        new HashMap<ControllerInterface, Integer>();
  ...
  private int i(String o, int theDefault) {
    return isNumeric(o)
        ? Integer.parseInt(o)
        : isHex(o)
            ? o.length() == 6 ? (int) Long.parseLong("FF" + o, 16) : (int) Long.parseLong(o, 16)
            : theDefault;
  }
