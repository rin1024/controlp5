...
public class Textarea extends ControllerGroup<Textarea> implements ControlListener {
  ...
  private void setup() {
    ...
    _myScrollbar =
        new Slider(cp5, _myParent, getName() + "Scroller", 0, 1, 1, _myWidth - 5, 0, 5, _myHeight);
    _myScrollbar.init();
  ...
  public Textarea showScrollbar() {
    ...
    boolean isScrollbar =
        _myHeight < (_myValueLabel.getTextHeight() + _myValueLabel.getLineHeight());
    if (isScrollbar) {
      _myScrollbar.show();
    }
    return this;
  ...
  public Textarea setText(String theText) {
    ...
    _myScrollbar.setHeight(
        _myHeight + _myValueLabel.getStyle().paddingTop + _myValueLabel.getStyle().paddingBottom);
    return this;
  }
  ...
  protected void preDraw(PGraphics theGraphics) {
    ...
    if (_myScrollbar.isVisible() || isColorBackground) {
      float x =
          _myWidth
              - _myScrollbarWidth
              + _myValueLabel.getStyle().paddingLeft
      ...
      int ww =
          _myWidth + _myValueLabel.getStyle().paddingLeft + _myValueLabel.getStyle().paddingRight;
      int hh =
          _myHeight + _myValueLabel.getStyle().paddingTop + _myValueLabel.getStyle().paddingBottom;
