...
public class Bang extends Controller<Bang> {
  ...
  /**
   * By default a bang is triggered when the mouse is pressed. use setTriggerEvent(Bang.PRESSED) or
   * setTriggerEvent(Bang.RELEASE) to define the action for triggering a bang. currently only
