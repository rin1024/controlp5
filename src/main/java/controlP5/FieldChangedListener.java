...
/**
 * the FieldChangedListener is used to observe changes of variables that are linked to a controller.
 * The FieldChangedListener is for primarily for internal use.
 *
...
class FieldChangedListener {
   ...
   *
   * <p>this can be done in a more elegant way using generics.
   *
   * @param theObject
   * @param theFieldName
   */
