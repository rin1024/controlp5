...
public class CColor implements Serializable {
  ...
  public String toString() {
    ...
    return ("bg ("
        ...
        + "), "
        + "captionlabel ("
        + (colorCaptionLabel >> 16 & 0xff)
        + ","
        + (colorCaptionLabel >> 8 & 0xff)
        + ","
        + (colorCaptionLabel >> 0 & 0xff)
        + "), "
        + "valuelabel ("
        + (colorValueLabel >> 16 & 0xff)
        + ","
        + (colorValueLabel >> 8 & 0xff)
        + ","
  ...
  public CColor setAlpha(int theAlpha) {
    System.out.println(
        "controlP5.CColor.setAlpha: setting alpha values disabled for this version of controlP5.");
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    CColor cc = (CColor) o;
    if (colorBackground != cc.colorBackground
        || colorForeground != cc.colorForeground
        || colorActive != cc.colorActive
        || colorCaptionLabel != cc.colorCaptionLabel
