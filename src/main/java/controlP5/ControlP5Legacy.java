...
public class ControlP5Legacy {
  ...
  public Background addBackground(
      ...
      int theW,
      int theHeight) {
    Background myController =
        new Background(
            base.cp5,
            (ControllerGroup<?>) base.cp5.controlWindow.getTabs().get(1),
            theName,
            theX,
            theY,
            theW,
  ...
  public Slider2D addSlider2D(
    ...
    myController
        .registerProperty("arrayValue")
        .registerProperty("minX")
        .registerProperty("maxX")
        .registerProperty("minY")
        .registerProperty("maxY");
    return myController;
  }
  ...
  public Range addRange(
      ...
      final int theHeight) {
    return addRange(
        null, "", theName, theMin, theMax, theMin, theMax, theX, theY, theWidth, theHeight);
  }
  ...
  public Range addRange(
      ...
      final int theHeight) {
    return addRange(
        theObject, theIndex, theName, theMin, theMax, theMin, theMax, theX, theY, theWidth,
        theHeight);
  }
  ...
  public Textlabel addTextlabel(
      ...
      final int theX,
      final int theY) {
    Textlabel myController =
        new Textlabel(
            base.cp5, (Tab) base.cp5.controlWindow.getTabs().get(1), theName, theText, theX, theY);
    base.cp5.register(theObject, theIndex, myController);
  ...
  public Textlabel addTextlabel(
      final String theName, final String theText, final int theX, final int theY) {
    return addTextlabel(null, "", theName, theText, theX, theY);
  }

  public Textlabel addTextlabel(
      final Object theObject, final String theIndex, final String theName, final String theText) {
  ...
  public Textfield addTextfield(
      final Object theObject, final String theIndex, final String theName) {
  ...
  public Accordion addAccordion(String theName, int theX, int theY, int theWidth) {
    Accordion myController =
        new Accordion(
            base.cp5, (Tab) base.cp5.controlWindow.getTabs().get(1), theName, theX, theY, theWidth);
    base.cp5.register(null, "", myController);
    return myController;
  }
  ...
  public Accordion addAccordion(
      final Object theObject, final String theIndex, final String theName) {
    Accordion myController =
        new Accordion(base.cp5, (Tab) base.cp5.controlWindow.getTabs().get(1), theName, 0, 0, 200);
    base.cp5.register(theObject, theIndex, myController);
    return myController;
  }
  ...
  public RadioButton addRadioButton(
      ...
      final int theX,
      final int theY) {
    RadioButton myController =
        new RadioButton(
            base.cp5, (Tab) base.cp5.controlWindow.getTabs().get(1), theName, theX, theY);
    base.cp5.register(theObject, theIndex, myController);
  ...
  public CheckBox addCheckBox(
      ...
      final int theX,
      final int theY) {
    CheckBox myController =
        new CheckBox(base.cp5, (Tab) base.cp5.controlWindow.getTabs().get(1), theName, theX, theY);
    base.cp5.register(theObject, theIndex, myController);
    myController.registerProperty("arrayValue");
    return myController;
  }
  ...
  public ScrollableList addScrollableList(
      final Object theObject, String theIndex, final String theName) {
  ...
  public ColorWheel addColorWheel(
      final String theName, final int theX, final int theY, final int theW) {
  ...
  public Group addGroup(
      Object theObject, final String theIndex, String theName, int theX, int theY, int theW) {
    Group myController =
        new Group(
            base.cp5,
            (ControllerGroup<?>) base.cp5.controlWindow.getTabs().get(1),
  ...
  public Toggle addToggle(
      Object theObject, final String theIndex, String theName, boolean theValue) {
    Toggle t =
        addToggle(
            theObject,
            theIndex,
  ...
  public Knob addKnob(
      Object theObject, final String theIndex, String theName, int theMin, int theMax) {
    Knob n =
        addKnob(
            theObject,
            theIndex,
  ...
  /**
   * Adds Controllers by Object reference, currently supports Slider, Bang, Button, Knob, Numberbox,
   * Toggle, Textlabel, Textfield, Range, Slider2D. For internal use rather than on application
   * level.
   */
  public <C> C addController(
      final Object theObject,
      final String theIndex,
      final String theName,
      final Class<C> theClass,
      int theX,
      int theY) {
    Controller<?> c = null;
  ...
  public static void println(final Object... strs) {
    for (Object str : strs) {
  ...
  @Deprecated
  public ControlWindow addControlWindow(
      final String theWindowName, final int theWidth, final int theHeight) {
  ...
  public Slider2D addSlider2D(
      ...
      int theH) {
    return addSlider2D(
        theObject, theIndex, theName, 0, theW, 0, theH, 0, 0, theX, theY, theW, theH);
  }
